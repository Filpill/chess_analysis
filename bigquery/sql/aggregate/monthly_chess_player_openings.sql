CREATE OR REPLACE TABLE `checkmate-453316.chess_aggregate.monthly_player_chess_openings` 
PARTITION BY game_month
CLUSTER BY game_month, time_class, opening_archetype, username
AS (
WITH cte_aggregate AS (
    ...
    FROM `checkmate-453316.chess_staging.monthly_player_games` games
